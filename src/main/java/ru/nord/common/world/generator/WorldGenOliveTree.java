...
{
    private static final IBlockState field_181653_a = NordBloks.nordLog2.getDefaultState().withProperty(BlockNordLog2.VARIANT,EnumNordPlank2.OLIVE);
    private static final IBlockState field_181654_b = Blocks.leaves.getDefaultState().withProperty(BlockNordLeaves2.VARIANT, EnumNordPlank2.OLIVE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    public WorldGenOliveTree(boolean doBlockNotify, int min, IBlockState meta, IBlockState metaL)
    {
        super(doBlockNotify);
