...
public class BlockNordLeaves extends BlockLeaves {
    ...
    public BlockNordLeaves()
    {
        this.setDefaultState(
                this.blockState.getBaseState()
                        .withProperty(VARIANT, EnumNordPlank.SOME_PLANK)
    ...
    {
        return EnumNordPlank.byMetadata((meta & 3) % 4);
    }
    @Override
    ...
    public List<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune)
    {
        ...
        return new ArrayList<ItemStack>(Arrays.asList(new ItemStack(this, 1, ((EnumNordPlank) state.getValue(VARIANT)).getMetadata())));
    }
