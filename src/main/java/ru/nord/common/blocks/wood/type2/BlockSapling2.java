...
public class BlockSapling2 extends BlockBush implements IGrowable {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        WorldGenerator tree = ((EnumNordPlank2)state.getValue(TYPE)).generate();
        int i = 0;
        int j = 0;
        boolean flag = false;
     ...
     */
    public boolean isTypeAt(World worldIn, BlockPos pos, EnumNordPlank2 type)
    {
    ...
    {
        return ((EnumNordPlank2)state.getValue(TYPE)).getMetadata();
    }
    ...
    {
        return this.getDefaultState().withProperty(TYPE, EnumNordPlank2.byMetadata(meta & 7)).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
    }
    ...
    {
        byte b0 = 0;
        int i = b0 | ((EnumNordPlank2)state.getValue(TYPE)).getMetadata();
