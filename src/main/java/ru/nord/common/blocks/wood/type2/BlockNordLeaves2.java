...
public class BlockNordLeaves2 extends BlockLeaves {
    ...
    public int colorMultiplier(IBlockAccess worldIn, BlockPos pos, int renderPass) {
        if (((EnumNordPlank2) worldIn.getBlockState(pos).getValue(VARIANT)).getColorize()) {
    ...
    protected void dropApple(World worldIn, BlockPos pos, IBlockState state, int chance) {
        ...
        EnumNordPlank2 apple = ((EnumNordPlank2) state.getValue(VARIANT));
    ...
    public EnumNordPlank2 getWoodType2(int meta) {
        return EnumNordPlank2.byMetadata((meta & 3));
    }
    ...
    public List<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
        ...
        return new ArrayList<ItemStack>(Arrays.asList(new ItemStack(this, 1, ((EnumNordPlank2) state.getValue(VARIANT)).getMetadata())));
    }
