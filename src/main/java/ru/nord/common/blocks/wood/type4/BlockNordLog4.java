...
public class BlockNordLog4 extends BlockLog {
    ...
    {
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT,  EnumNordPlank4.APRICOT).withProperty(LOG_AXIS, net.minecraft.block.BlockLog.EnumAxis.Y));
    }
    ...
    {
        IBlockState iblockstate = this.getDefaultState().withProperty(VARIANT, EnumNordPlank4.byMetadata((meta & 3)));
